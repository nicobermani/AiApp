      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6">
          <textarea
            ...
            className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-md focus:outline-none focus:ring focus:ring-blue-500 resize-none"
            rows="4"
          />
          <div className="flex items-center mt-2">
            ...
            <input
              ...
              className="bg-gray-800 border border-gray-700 rounded-md px-2 py-1 text-white focus:outline-none focus:ring focus:ring-blue-500 w-20"
            />
            <button
              onClick={handleAskAi}
              className="bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-4 rounded-md ml-auto"
            >
              Ask AI
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          {responses.map((response, index) => (
            <div
              key={index}
              className={`bg-gray-800 rounded-md p-4 overflow-auto min-h-[150px] shadow-md ${
                maximizedResponse === index
                  ? "fixed inset-0 z-50 p-8 bg-gray-900"
                  : ""
              }`}
            >
              <div className="flex justify-between items-center mb-2">
                ...
                <button
                  ...
                  className="bg-indigo-500 hover:bg-indigo-600 text-white font-medium py-1 px-2 rounded-md"
                >
